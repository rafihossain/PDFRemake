                                                ...
                                                <div id="client_form" class="row">
                                                    ...
                                                    <?php if($template_id == 1){ ?>
                                                        <div class="col-12 mb-2" id="template_one_add_sponsor_info" style="display:none;">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <input type="text" class="form-control" name="sn_first_box" placeholder="Sponsor First Name" id="add_sn_first_box" maxlength="29" autocomplete="off">
                                                                        <span class="text-danger" id="sn_first_box_error"></span>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <input type="text" class="form-control" name="sn_second_box" placeholder="Sponsor Last Name" id="add_sn_second_box" maxlength="29" autocomplete="off">
                                                    ...
                                                    <?php } else { ?>
                                                        ...
                                                        <div class="col-12 mb-2" id="add_sponsor_info" style="display:none;">
                                                            <label class="form-label">Sponsor Name اسم الكفيل</label>
                                                            <input type="text" class="form-control" name="sponsor_name" placeholder="Sponsor Name" id="add_sponsor_name" autocomplete="off"
                                                ...
                                                <div id="facebook_groups" class="row">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mb-4 row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" name="sponsored_person" id="policyHolder" class="form-control" placeholder="Please enter sponsored person name" autocomplete="off"
...
<div id="pdfGeneratingModel" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
	...
	$(function(){
		...
		$('#add_sponsor_name').keyup(function(e){
            ...
            if (!((key == 8) || (key == 32) || (key == 46) || (key >= 35 && key <= 40) || (key >= 65 && key <= 90))) {
                ...
                $(this).val(string);
                $('#sponsor_name_error').text('You should enter only character not number!');
            }
        ...
        $('#policyHolder').keyup(function(e){
            ...
            if (!((key == 8) || (key == 32) || (key == 46) || (key >= 35 && key <= 40) || (key >= 65 && key <= 90))) {
                var string = $(this).val().replace(/\d+/g, '');
                $(this).val(string);
                $('#sponsor_person_name_error').text('You should enter only character not number!');
            }
            ...
            $('#add_sn_first_box').keyup(function(e){
                ...
                if (e.shiftKey || e.ctrlKey || e.altKey) {
                    ...
                    if (!((key == 8) || (key == 32) || (key == 46) || (key >= 35 && key <= 40) || (key >= 65 && key <= 90))) {
                        var string = $(this).val().replace(/\d+/g, '');
                        $(this).val(string);
                        $('#sn_first_box_error').text('You should enter only character not number!');
                    }
                }
            ...
            $('#add_sn_second_box').keyup(function(e){
                ...
                if (e.shiftKey || e.ctrlKey || e.altKey) {
                    ...
                    if (!((key == 8) || (key == 32) || (key == 46) || (key >= 35 && key <= 40) || (key >= 65 && key <= 90))) {
                        var string = $(this).val().replace(/\d+/g, '');
                        $(this).val(string);
                        $('#sn_second_box_error').html('You should enter only character not number!');
                    }
                }
